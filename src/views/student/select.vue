        ...
        :data="
          tableData
            .filter(
              (data) =>
                !search ||
                data.cosSta.toLowerCase().includes(search.toLowerCase()) ||
                data.cosTea.toLowerCase().includes(search.toLowerCase()) ||
                data.cosId.toLowerCase().includes(search.toLowerCase()) ||
                data.cosName.toLowerCase().includes(search.toLowerCase())
            )
        ...
        <el-table-column align="left">
          ...
          <template slot-scope="scope">
            ...
            <el-button
              size="mini"
              type="danger"
              @click="delCourses(scope.row.cosId)"
              v-if="scope.row.cosflags"
              >退课</el-button
            >
          </template>
...
export default {
  ...
  beforeCreate() {
    // this.$store.dispatch('student/getLessons').then(() => {
